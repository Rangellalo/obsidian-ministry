...
### Rich Typography
- **Georgia** serif font for headings — conveys gravitas and timelessness, available on all systems offline
- Clean system sans-serif for body text — crisp, modern readability
...
> **Optional:** To use **Cinzel** (headings) and **Inter** (body) instead of system fonts, add this CSS snippet to your vault:
> ```css
> @import url('https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600;700&family=Inter:wght@300;400;500;600;700;800&display=swap');
> body { --font-heading: 'Cinzel', Georgia, serif; --font-body: 'Inter', sans-serif; }
> ```
...
This theme synthesizes ideas and styling patterns from three existing works:

- **Ex Verbo Vita** — Callout system, scripture styling, projector mode, and color philosophy
- **Preaching Desk** — Sermon outline hierarchy, table styling, reading-width optimization, and print modes
- **Obuntu** — UI element styling, tag pills, custom checkboxes, and mermaid theming

All original creators are credited for their foundational work in Obsidian ministry tooling.
